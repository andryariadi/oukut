...
const HomePage = () => {
  return (
    <div className="b-amber-600">
      <div className="b-sky-600 max-w-7xl mx-auto px4 md:px-8 lg:px-16 py-16 flex flex-col items-center gap-10">
        <div className="text-center b-violet-500">
          <h1 className="text-5xl sm:text-6xl font-bold bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text h-[4.5rem]">Explore Our Categories</h1>
